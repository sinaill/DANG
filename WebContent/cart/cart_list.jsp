					  ...
					  <s:iterator value="items">
					   <s:if test="buy==true">
					      <tr class='td_no_bord'>
							...
							<td>
								<a href="delete.action?pid=${product.id}">删除</a>
							</td>
						</tr>
					   </s:if>
				...
				<div class="choice_balance">
					...
					<div class="total_balance">
						...
						<div id="balance" class="balance">
							<a name='checkout' href='../order/confirmorder.action' > 
			...
			<table class=tabl_del id=del_table>
			  ...
			  <s:else>
			    ...
			    <p>
						...
						<a href='../main/main.jsp'> 您还没有选购商品，请挑选商品>></a>
			    </p>
			  </s:else>
		<!--页尾开始 -->
